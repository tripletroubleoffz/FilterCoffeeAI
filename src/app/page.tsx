...
import { ArrowRight, Check, Flame, Cpu, TrendingUp, Briefcase, Calendar, LayoutDashboard, LogOut } from 'lucide-react';
    ...
    return (
      <>
        ...
        <button
          ...
          title="Sign Out"
          className="text-coffee-text-muted hover:text-coffee-accent transition-colors bg-transparent border-none p-1 cursor-pointer"
        >
